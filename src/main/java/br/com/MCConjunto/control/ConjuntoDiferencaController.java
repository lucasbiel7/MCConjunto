 ...
 * @author lucas
 */
public class ConjuntoDiferencaController implements Initializable {
    ...
    private void onActionConjuntoDiferenca(ActionEvent ae) {
          if(cbPrimeiroConjunto.getSelectionModel().getSelectedItem()!=null && cbSegundoConjunto.getSelectionModel().getSelectedItem()!=null){
            resultado=manipularConjunto.conjuntoDiferenca(cbPrimeiroConjunto.getSelectionModel().getSelectedItem(), cbSegundoConjunto.getSelectionModel().getSelectedItem());
